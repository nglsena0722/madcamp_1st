package com.example.phonebookimagetotab.views.grid;
...
public class Cell extends com.example.phonebookimagetotab.views.grid.BaseCell implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onClick(View v) {
        com.example.phonebookimagetotab.GameEngine.getInstance().click(getXPos(), getYPos());
    }

    @Override
    public boolean onLongClick(View v) {
        if (!isClicked()) com.example.phonebookimagetotab.GameEngine.getInstance().flag(getXPos(), getYPos());
        return true;
    }
